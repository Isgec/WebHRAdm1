Partial Class AF_admCallStatus
	Inherits System.Web.UI.Page
	Private _CancelUrl As String = "~/ADM_Main/App_Forms/GF_admCallStatus.aspx"
	...
	Protected Sub FormView1_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FormView1.PreRender
		...
		Dim validateScript As String = "<script type=""text/javascript"">" & _
		 "  function validatePK_admCallStatus(o) {" & _
		 "    var value = o.id;" & _
		 ...
		 "    PageMethods.validatePK_admCallStatus(value, validatedPK_admCallStatus);" & _
		 "  }" & _
		 "  function validatedPK_admCallStatus(result) {" & _
		 ...
		 "  }" & _
			"</script>"
		If Not Page.ClientScript.IsClientScriptBlockRegistered("validatePKadmCallStatus") Then
			Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validatePKadmCallStatus", validateScript)
		End If
	End Sub
	<System.Web.Services.WebMethod()> _
	 Public Shared Function validatePK_admCallStatus(ByVal value As String) As String
		Dim aVal() As String = value.Split(",".ToCharArray)
		Dim mRet As String = "0|" & aVal(0)
		Dim CallStatusID As String = CType(aVal(1), String)
		Dim oVar As SIS.ADM.admCallStatus = SIS.ADM.admCallStatus.GetByID(CallStatusID)
