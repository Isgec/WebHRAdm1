<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_admITCallStatus.aspx.vb" Inherits="AF_admITCallStatus" title="Add: Call Status" %>
...
<asp:FormView ID="FormView1"
    ...
    <LGM:ToolBar0 
      ...
      runat = "server" />
    <hr />
    <asp:Label ID="LabeladmITCallStatus" runat="server" Text="Add Call Status" CssClass="sis_formheading"></asp:Label>
