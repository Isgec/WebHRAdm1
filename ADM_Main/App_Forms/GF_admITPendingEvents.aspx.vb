Partial Class GF_admITPendingEvents
	Inherits System.Web.UI.Page
	Private _EditUrl As String = "~/ADM_Main/App_Edit/EF_admITEventTransactions.aspx"
	Private _AddUrl As String = "~/ADM_Main/App_Create/AF_admITEventTransactions.aspx"
	Private _InfoUrl As String = "~/ADM_Main/App_Display/DF_admITEventTransactions.aspx"
	Protected Sub Edit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
		Dim oBut As ImageButton = CType(sender, ImageButton)
		Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
		Dim RedirectUrl As String = _EditUrl & "?EventID=" & aVal(0)
		Response.Redirect(RedirectUrl)
	End Sub
	Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
		Dim oBut As ImageButton = CType(sender, ImageButton)
		Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
		Dim RedirectUrl As String = _InfoUrl & "?EventID=" & aVal(0)
		Response.Redirect(RedirectUrl)
	End Sub
	...
	<System.Web.Services.WebMethod()> _
	<System.Web.Script.Services.ScriptMethod()> _
	 Public Shared Function GetCircularText(ByVal intEventID As String) As String
		Dim oB As SIS.ADM.admITEventTransactions = SIS.ADM.admITEventTransactions.GetByID(intEventID)
		Return oB.Circular
	End Function
	<System.Web.Services.WebMethod()> _
	<System.Web.Script.Services.ScriptMethod()> _
	 Public Shared Function GetEmployeeInfo(ByVal CardNo As String) As String
	...
	Protected Sub cmd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd.Click
		GridView1.DataBind()
	End Sub
End Class
