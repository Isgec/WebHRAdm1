<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_admInitiatorSheetHeader.aspx.vb" Inherits="GF_admInitiatorSheetHeader" title="Maintain List: Sheet By Initiator" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EnableAdd = "False"
      ValidationGroup = "admInitiatorSheetHeader"
      runat = "server" />
    <hr />
    <asp:Label ID="LabeladmInitiatorSheetHeader" runat="server" Text="List Sheet By Initiator" CssClass="sis_formheading"></asp:Label>
    ...
    <hr />
		<script type="text/javascript">
			...
			function print_Report(o) {
				...
				url = url + '?reportname=initiatorsheet';
    ...
    <asp:GridView ID="GridView1" width="100%" SkinID="gridviewSkin" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="SheetID">
      <Columns>
          ...
          <ItemTemplate>
            <table>
							<tr>
								...
								<td style="width: 30px">
									<asp:ImageButton ID="Info" runat="server" AlternateText="Info" ToolTip="Validate Backup." SkinID="Info" CommandName="ValidateBackup" CommandArgument='<%#EVal("SheetID")%>' />
								</td>
							</tr>
            </table>
          </ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Sheet ID" SortExpression="SheetID">
          <ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      runat = "server"
      DataObjectTypeName = "SIS.ADM.admInitiatorSheetHeader"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "SelectList"
      TypeName = "SIS.ADM.admInitiatorSheetHeader"
