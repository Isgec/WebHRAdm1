Partial Class GF_admPendingProblems
  Inherits System.Web.UI.Page
  Private _EditUrl As String = "~/ADM_Main/App_Edit/EF_admPendingProblems.aspx"
  Private _AddUrl As String = "~/ADM_Main/App_Create/AF_admPendingProblems.aspx"
  Private _InfoUrl As String = "~/ADM_Main/App_Display/DF_admPendingProblems.aspx"
  ...
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?SheetID=" & aVal(0) & "&SerialNo=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
  ...
  Protected Sub F_ServiceID_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles F_ServiceID.SelectedIndexChanged
    ...
    End If
  End Sub
  Protected Sub F_CheckPointID_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles F_CheckPointID.SelectedIndexChanged
    Session("F_CheckPointID") = F_CheckPointID.SelectedValue
    Dim FileName As String = System.IO.Path.GetFileName(System.Web.HttpContext.Current.Request.Url.AbsolutePath)
    If Session("PageNoProvider") = True Then
      SIS.SYS.Utilities.GlobalVariables.PageNo(FileName, HttpContext.Current.Session("LoginID"), 0)
    Else
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    If Not Session("F_ServiceID") Is Nothing Then
      ...
      End If
    End If
    F_CheckPointID.SelectedValue = String.Empty
    If Not Session("F_CheckPointID") Is Nothing Then
      If Session("F_CheckPointID") <> String.Empty Then
        F_CheckPointID.SelectedValue = Session("F_CheckPointID")
      End If
    End If
  End Sub
