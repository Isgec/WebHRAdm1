Partial Class GF_admEmployeeEMailGroup
  Inherits System.Web.UI.Page
  Private _EditUrl As String = "~/ADM_Main/App_Edit/EF_admEmployeeEMailGroup.aspx"
  Private _AddUrl As String = "~/ADM_Main/App_Create/AF_admEmployeeEMailGroup.aspx"
  Private _InfoUrl As String = "~/ADM_Main/App_Display/DF_admEmployeeEMailGroup.aspx"
  Protected Sub Edit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _EditUrl  & "?CardNo=" & aVal(0) & "&EMailGroup=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?CardNo=" & aVal(0) & "&EMailGroup=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
