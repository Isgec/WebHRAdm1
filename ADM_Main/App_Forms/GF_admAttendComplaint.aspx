<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_admAttendComplaint.aspx.vb" Inherits="GF_admAttendComplaint" title="Maintain List: Attend Complaints" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EnableAdd = "False"
      ValidationGroup = "admAttendComplaint"
      runat = "server" />
    <hr />
    <asp:Label ID="LabeladmAttendComplaint" runat="server" Text="List Attend Complaints" CssClass="sis_formheading"></asp:Label>
    ...
    <script type="text/javascript">
    	function showPopup(o) {
    		...
    		$get('<%=IfBd1.ClientID %>').src = 'GF_admComplaintResponse.aspx?CallID=' + aval[0];
    		return false;
    	}
    	function hidePopup() {
    		$find('mpe99bid').hide();
    ...
    <asp:ObjectDataSource 
      ...
      runat = "server"
      DataObjectTypeName = "SIS.ADM.admAttendComplaint"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "SelectList"
      TypeName = "SIS.ADM.admAttendComplaint"
