Partial Class GF_admInitiators
  Inherits System.Web.UI.Page
  Private _EditUrl As String = "~/ADM_Main/App_Edit/EF_admInitiators.aspx"
  Private _AddUrl As String = "~/ADM_Main/App_Create/AF_admInitiators.aspx"
  Private _InfoUrl As String = "~/ADM_Main/App_Display/DF_admInitiators.aspx"
  Protected Sub Edit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _EditUrl  & "?ServiceID=" & aVal(0) & "&InitiatorID=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?ServiceID=" & aVal(0) & "&InitiatorID=" & aVal(1)
    Response.Redirect(RedirectUrl)
  End Sub
