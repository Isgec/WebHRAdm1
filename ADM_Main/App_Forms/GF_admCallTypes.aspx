<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_admCallTypes.aspx.vb" Inherits="GF_admCallTypes" title="Maintain List: Call Types" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ID = "ToolBar0_1"
      ToolType = "lgNMGrid"
	EditUrl = "~/ADM_Main/App_Edit/EF_admCallTypes.aspx"
	AddUrl = "~/ADM_Main/App_Create/AF_admCallTypes.aspx"
