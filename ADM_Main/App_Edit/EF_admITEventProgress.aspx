<%@ Page Language="VB" MasterPageFile="~/Plain.master" AutoEventWireup="false" CodeFile="EF_admITEventProgress.aspx.vb" Inherits="EF_admITEventProgress" title="Edit: HRIS Event Progress" %>
...
<asp:FormView ID="FormView1"
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMEdit"
      EnableDelete = "False"
      ValidationGroup = "admITEventProgress"
      runat = "server" />
    <hr />
    <asp:Label ID="LabeladmITEventProgress" runat="server" Text="Edit HRIS Event Progress" CssClass="sis_formheading"></asp:Label>
    <hr />
		<table>
			<tr>
				<td class="alignright">
					<b><asp:Label ID="Label1" runat="server" ForeColor="#CC6633" Text="Employee Info :" /></b>
				</td>
        <td>
					<asp:Label ID="PnlEmpInfo" runat="server" Width="100%" ></asp:Label>
        </td>
			</tr>
			<tr>
				<td class="alignright">
        ...
        <td>
			...
			<tr>
				...
				<td>
            <asp:Button ID="cmdUpdateButton"
						  CommandName="Update"
						  Visible="false"
						  CssClass="ok_button"
						  Text="Submit"
						  OnClientClick="return hideProgressPopup(this);"
						  ValidationGroup = "admITEventProgress"
              runat="server" />
				</td>
			</tr>
		...
		<script type="text/javascript">
			function hideProgressPopup(o) {
				window.parent.lgMessageBox.close();
				return true;
			}
		</script>
	</EditItemTemplate>
