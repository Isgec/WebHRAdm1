<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_admAttendComplaint.aspx.vb" Inherits="EF_admAttendComplaint" title="Edit: Attend Complaints" %>
...
<asp:FormView ID="FormView1"
    ...
    <LGM:ToolBar0 
      ...
      runat = "server" />
    <hr />
    <asp:Label ID="LabeladmAttendComplaint" runat="server" Text="Edit Attend Complaints" CssClass="sis_formheading"></asp:Label>
    <hr />
		<table>
			<tr>
				<td class="alignright">
