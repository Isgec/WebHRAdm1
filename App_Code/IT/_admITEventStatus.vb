...
Namespace SIS.ADM
  <DataObject()> _
  Partial Public Class admITEventStatus
    ...
    Public Shared Function GetNewRecord() As SIS.ADM.admITEventStatus
      Dim Results As SIS.ADM.admITEventStatus = Nothing
      Results = New SIS.ADM.admITEventStatus()
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal EventID As Int32, ByVal ITServiceID As String) As SIS.ADM.admITEventStatus
      Dim Results As SIS.ADM.admITEventStatus = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusSelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.ADM.admITEventStatus(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal EventID As Int32, ByVal ITServiceID As String, ByVal Filter_EventID As Int32, ByVal Filter_ITServiceID As String) As SIS.ADM.admITEventStatus
      Return GetByID(EventID, ITServiceID)
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByEventID(ByVal EventID As Int32, ByVal OrderBy as String) As List(Of SIS.ADM.admITEventStatus)
      Dim Results As List(Of SIS.ADM.admITEventStatus) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusSelectByEventID"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@EventID",SqlDbType.Int,EventID.ToString.Length, EventID)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@OrderBy", SqlDbType.NVarChar, 50, OrderBy)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
          Cmd.Parameters("@RecordCount").Direction = ParameterDirection.Output
          _RecordCount = -1
          Results = New List(Of SIS.ADM.admITEventStatus)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.ADM.admITEventStatus(Reader))
          End While
          Reader.Close()
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByITServiceID(ByVal ITServiceID As String, ByVal OrderBy as String) As List(Of SIS.ADM.admITEventStatus)
      Dim Results As List(Of SIS.ADM.admITEventStatus) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusSelectByITServiceID"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@ITServiceID",SqlDbType.NVarChar,ITServiceID.ToString.Length, ITServiceID)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@OrderBy", SqlDbType.NVarChar, 50, OrderBy)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
          Cmd.Parameters("@RecordCount").Direction = ParameterDirection.Output
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal EventID As Int32, ByVal ITServiceID As String) As List(Of SIS.ADM.admITEventStatus)
      Dim Results As List(Of SIS.ADM.admITEventStatus) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spadmITEventStatusSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spadmITEventStatusSelectListFilteres"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@Filter_EventID",SqlDbType.Int,10, IIf(EventID = Nothing, 0,EventID))
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@Filter_ITServiceID",SqlDbType.NVarChar,15, IIf(ITServiceID Is Nothing, String.Empty,ITServiceID))
					End If
    ...
    Public Shared Function Insert(ByVal Record As SIS.ADM.admITEventStatus) As Int32
      Dim _Result As Int32 = Record.EventID
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusInsert"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@EventID",SqlDbType.Int,11, Record.EventID)
    ...
    Public Shared Function Update(ByVal Record As SIS.ADM.admITEventStatus) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusUpdate"
    ...
    Public Shared Function Delete(ByVal Record As SIS.ADM.admITEventStatus) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITEventStatusDelete"
      ...
      Return _Result
    End Function
    Public Shared Function SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal EventID As Int32, ByVal ITServiceID As String) As Integer
      Return _RecordCount
    End Function
'		Autocomplete Method
		Public Shared Function SelectadmITEventStatusAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spadmITEventStatusAutoCompleteList"
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.ADM.admITEventStatus = New SIS.ADM.admITEventStatus(Reader)
