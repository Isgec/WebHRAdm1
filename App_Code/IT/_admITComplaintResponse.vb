...
Namespace SIS.ADM
  ...
  Partial Public Class admITComplaintResponse
    ...
    Private _FK_ADM_ITComplaintResponse_ADM_Users As SIS.ADM.admUsers = Nothing
    ...
    Public Property PrimaryKey() As String
      ...
      End Set
    End Property
    Public ReadOnly Property FK_ADM_ITComplaintResponse_ADM_Users() As SIS.ADM.admUsers
      Get
        If _FK_ADM_ITComplaintResponse_ADM_Users Is Nothing Then
          _FK_ADM_ITComplaintResponse_ADM_Users = SIS.ADM.admUsers.GetByID(_AttendedBy)
        End If
        Return _FK_ADM_ITComplaintResponse_ADM_Users
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetNewRecord() As SIS.ADM.admITComplaintResponse
      Dim Results As SIS.ADM.admITComplaintResponse = Nothing
      Results = New SIS.ADM.admITComplaintResponse()
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal CallID As Int32, ByVal SerialNo As Int32) As SIS.ADM.admITComplaintResponse
      Dim Results As SIS.ADM.admITComplaintResponse = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITComplaintResponseSelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.ADM.admITComplaintResponse(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal CallID As Int32, ByVal SerialNo As Int32, ByVal Filter_CallID As Int32) As SIS.ADM.admITComplaintResponse
      Return GetByID(CallID, SerialNo)
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByCallID(ByVal CallID As Int32, ByVal OrderBy as String) As List(Of SIS.ADM.admITComplaintResponse)
      Dim Results As List(Of SIS.ADM.admITComplaintResponse) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          If OrderBy = String.Empty Then OrderBy = "AttendedOn DESC"
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITComplaintResponseSelectByCallID"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@CallID",SqlDbType.Int,CallID.ToString.Length, CallID)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@OrderBy", SqlDbType.NVarChar, 50, OrderBy)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
          Cmd.Parameters("@RecordCount").Direction = ParameterDirection.Output
          _RecordCount = -1
          Results = New List(Of SIS.ADM.admITComplaintResponse)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.ADM.admITComplaintResponse(Reader))
          End While
          Reader.Close()
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal CallID As Int32) As List(Of SIS.ADM.admITComplaintResponse)
      Dim Results As List(Of SIS.ADM.admITComplaintResponse) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          If OrderBy = String.Empty Then OrderBy = "AttendedOn DESC"
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spadmITComplaintResponseSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spadmITComplaintResponseSelectListFilteres"
    ...
    Public Shared Function Insert(ByVal Record As SIS.ADM.admITComplaintResponse) As Int32
      Dim _Result As Int32 = Record.SerialNo
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITComplaintResponseInsert"
    ...
    Public Shared Function Update(ByVal Record As SIS.ADM.admITComplaintResponse) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITComplaintResponseUpdate"
    ...
    Public Shared Function Delete(ByVal Record As SIS.ADM.admITComplaintResponse) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmITComplaintResponseDelete"
    ...
    End Function
'		Autocomplete Method
		Public Shared Function SelectadmITComplaintResponseAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spadmITComplaintResponseAutoCompleteList"
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.ADM.admITComplaintResponse = New SIS.ADM.admITComplaintResponse(Reader)
    ...
    Public Sub New(ByVal Reader As SqlDataReader)
      ...
      _FK_ADM_ITComplaintResponse_ADM_Users = New SIS.ADM.admUsers("aspnet_users2",Reader)
    End Sub
