...
Namespace SIS.ADM
  <DataObject()> _
  Partial Public Class admInitiatorSheetHeader
    ...
    Public Shared Function GetNewRecord() As SIS.ADM.admInitiatorSheetHeader
      Dim Results As SIS.ADM.admInitiatorSheetHeader = Nothing
      Results = New SIS.ADM.admInitiatorSheetHeader()
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal SheetID As Int32) As SIS.ADM.admInitiatorSheetHeader
      Dim Results As SIS.ADM.admInitiatorSheetHeader = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmInitiatorSheetHeaderSelectByID"
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@SheetID",SqlDbType.Int,SheetID.ToString.Length, SheetID)
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.ADM.admInitiatorSheetHeader(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal SheetID As Int32, ByVal Filter_ServiceID As String, ByVal Filter_ScheduleID As String) As SIS.ADM.admInitiatorSheetHeader
      Return GetByID(SheetID)
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal ServiceID As String, ByVal ScheduleID As String) As List(Of SIS.ADM.admInitiatorSheetHeader)
      Dim Results As List(Of SIS.ADM.admInitiatorSheetHeader) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          If OrderBy = String.Empty Then OrderBy = "SheetDate DESC"
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spadmInitiatorSheetHeaderSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spadmInitiatorSheetHeaderSelectListFilteres"
          ...
          _RecordCount = -1
          Results = New List(Of SIS.ADM.admInitiatorSheetHeader)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.ADM.admInitiatorSheetHeader(Reader))
          End While
          Reader.Close()
    ...
    Public Shared Function Update(ByVal Record As SIS.ADM.admInitiatorSheetHeader) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmInitiatorSheetHeaderUpdate"
    ...
    End Function
'		Autocomplete Method
		Public Shared Function SelectadmInitiatorSheetHeaderAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spadmInitiatorSheetHeaderAutoCompleteList"
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.ADM.admInitiatorSheetHeader = New SIS.ADM.admInitiatorSheetHeader(Reader)
