...
Namespace SIS.ADM
  ...
  Partial Public Class admMonitorSheetDetails
    ...
    Public Shared Function GetNewRecord() As SIS.ADM.admMonitorSheetDetails
      Dim Results As SIS.ADM.admMonitorSheetDetails = Nothing
      Results = New SIS.ADM.admMonitorSheetDetails()
      Return Results
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal SheetID As Int32, ByVal SerialNo As Int32) As SIS.ADM.admMonitorSheetDetails
      Dim Results As SIS.ADM.admMonitorSheetDetails = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmMonitorSheetDetailsSelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.ADM.admMonitorSheetDetails(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.ADM.admMonitorSheetDetails)
      Dim Results As List(Of SIS.ADM.admMonitorSheetDetails) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spadmMonitorSheetDetailsSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spadmMonitorSheetDetailsSelectListFilteres"
					End If
    ...
    Public Shared Function Update(ByVal Record As SIS.ADM.admMonitorSheetDetails) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spadmMonitorSheetDetailsUpdate"
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@MonitoredBy",SqlDbType.NVarChar,9, Global.System.Web.HttpContext.Current.Session("LoginID"))
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@MonitoredOn",SqlDbType.DateTime,21, Now)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@Monitored",SqlDbType.Bit,3, 1)
    ...
    End Function
'		Autocomplete Method
		Public Shared Function SelectadmMonitorSheetDetailsAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
			Dim Results As List(Of String) = Nothing
      Dim aVal() As String = contextKey.Split("|".ToCharArray)
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spadmMonitorSheetDetailsAutoCompleteList"
					...
					End If
					While (Reader.Read())
            Dim Tmp As SIS.ADM.admMonitorSheetDetails = New SIS.ADM.admMonitorSheetDetails(Reader)
